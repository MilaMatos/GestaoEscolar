...
public class SistemaEscolar {
    public static void main(String[] args) {
       Financeiro geral = new Financeiro();
        ...
        Aluno a = new Aluno("Rayssa Alves", "15/02/2003", "feminino", "(88) 992325912", "Monsenhor Fco de Assis Feitosa", 381, "Centro", "Casa", "Crato", "63100-360", 1, "Ronilce", "1º ano", 350, geral);
