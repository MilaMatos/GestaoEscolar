...
public class AbaInicial extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        menuAlunos.getAccessibleContext().setAccessibleDescription("");
        ...
        TituloGestao.getAccessibleContext().setAccessibleDescription("");

        setSize(new java.awt.Dimension(1000, 539));
        setLocationRelativeTo(null);
    }// </editor-fold>                        

    private void jMenuItemCadAluActionPerformed(java.awt.event.ActionEvent evt) {                                                
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                //new AbaInicial(financeiro).setVisible(true);
            }
        });
    }
